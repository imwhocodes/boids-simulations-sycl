...
set_target_properties(RtMidi::rtmidi PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/librtmidi.6.0.0.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/librtmidi.6.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS RtMidi::rtmidi )
list(APPEND _IMPORT_CHECK_FILES_FOR_RtMidi::rtmidi "${_IMPORT_PREFIX}/lib/librtmidi.6.0.0.dylib" )
